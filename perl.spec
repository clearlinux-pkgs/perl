...
%prep
%setup -q -n perl-5.38.2
cd %{_builddir}/perl-5.38.2
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701984304
